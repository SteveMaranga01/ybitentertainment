...
export function PageHero({
  ...
  return (
    <section className="relative isolate min-h-[88svh] overflow-hidden pt-28">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,5,5,0.98),rgba(5,5,5,0.48)_40%,rgba(5,5,5,0.88)),linear-gradient(180deg,transparent_50%,rgba(5,5,5,0.96))]" />
      <div className="ybit-container relative z-10 flex min-h-[calc(88svh-7rem)] items-end pb-12 md:pb-16">
        <div className="grid w-full gap-8 lg:grid-cols-[minmax(0,1fr)_220px] lg:items-end">
          <div className="max-w-6xl">
            ...
            <h1 className="max-w-5xl font-serif text-[clamp(4.1rem,10vw,10rem)] font-semibold leading-[0.8] tracking-[-0.06em] text-ybit-custom">{title}</h1>
