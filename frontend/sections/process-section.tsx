import { processSteps } from "@/frontend/data/home";
import { SectionIntro } from "@/frontend/sections/section-intro";
        ...
        <div className="mt-14 grid gap-px overflow-hidden border border-white/10 bg-white/10 md:grid-cols-4">
          {processSteps.map((item) => (
            <div key={item.step} className="bg-ybit-black p-7 md:min-h-[300px] md:p-8">
              ...
              <h3 className="mt-8 font-serif text-4xl text-white">{item.title}</h3>
